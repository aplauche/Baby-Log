  ...
  return (
    <div className="min-h-[calc(100vh-4rem)]">
      ...
      <section className="py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto">
          <div className="mb-4 flex justify-center">
            <img src="/elly.png" alt="BabyLog mascot" className="h-24 w-auto" />
          </div>
          <h1 className="text-6xl md:text-7xl font-bold leading-tight mb-4"
              style={{ fontFamily: "var(--font-caveat), cursive", color: "#1a1a2e" }}>
            Meet <span style={{ color: "#FF6EB4", WebkitTextStroke: "1px #1a1a2e" }}>Ella</span>
          </h1>
          <p className="py-4 text-base max-w-lg mx-auto leading-relaxed"
             style={{ fontFamily: "var(--font-nunito), sans-serif", color: "#4a3d6b" }}>
            Your personal companion to effortlessly log feedings and diaper changes, and
            spot patterns in your baby&apos;s routine.
          </p>
      ...
      {/* <section className="py-14 px-6 text-center" >
        <div className="max-w-lg mx-auto card-scrapbook p-8"
             >
